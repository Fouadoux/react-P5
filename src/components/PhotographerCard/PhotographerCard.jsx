  ...
  return (
    <Link href={`/photographer/${id}`}>
      ...
      <article className="flex flex-col items-center text-center w-55 cursor-pointer group">
        ...
        <h2 className="text-[#D3573C] text-[36px] font-normal mb-1 whitespace-nowrap ">{name}</h2>
        <p className="text-[#901C1C] text-[13px] mb-1">{city}, {country}</p>
        <p className="text-[#000000] font-bold text-[10px] mb-2 whitespace-nowrap">{tagline}</p>
        <p className="text-[#757575] text-[9px]">{price}€/jour</p>
      </article>
    </Link>
